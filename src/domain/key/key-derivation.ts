...
export class KeyDerivation {
  ...
  static deriveFrom(key: Buffer<ArrayBuffer>, salt: string, keytype: KekType | string, environment: string, version: number) {
  ...
  static getRandom(bytes: number = this.KEY_LENGTH) {
