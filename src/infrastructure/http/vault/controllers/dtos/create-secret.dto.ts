import type { SecretType } from "@domain/secret/secret";
...
export class CreateSecretDto {
  ...
  type: SecretType;
  @ApiProperty({ example: "418c94da-c9f5-43a5-b564-5aed72169a0b", description: "ID of the application this secret belongs to" })
  applicationId: string;
  @ApiProperty({ example: "a381260d-c54c-40bd-af9b-31ae727285fb", description: "ID of the role that owns this secret" })
  ownerRoleId: string;
