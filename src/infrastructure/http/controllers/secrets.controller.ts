...
export class SecretsController {
  ...
  async getSecretVersinoData(@Param("secretId") secretId: string): Promise<ReturnType<GetSecretVersionUseCase["execute"]>> {
    return await this.getSecretVersionUsecase.execute({ secretId, actorId: UniqueId.create().toString() /* In real implementation, actorId should come from authenticated user context */ });
  }
